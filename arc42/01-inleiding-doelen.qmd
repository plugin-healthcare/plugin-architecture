...
## Requirementsoverzicht {#sec-requirementsoverzicht}

Het **Pl**atform voor **U**itwisseling en Her**g**ebruik van Kl**i**nische Data **N**ederland (PLUGIN) beoogt klinische data die routinematig in ziekenhuizen wordt vastgelegd op een veilige, schaalbare en duurzame wijze te ontsluiten voor secundair gebruik. PLUGIN richt zich op het ondersteunen van alle stappen in het proces van secundair gebruik zoals in TEHDAS2 is gedefinieerd.[^inleiding-1] 

![Proces van secundair gebruik van data. Bron: [TEHDAS2](https://tehdas.eu)](./images/ehds-user-journey.svg).
...
Voordat een datagebruiker gezondheidsgegevens kan gebruiken, moet worden nagegaan of de benodigde gegevens beschikbaar zijn in het benodigde formaat voor het secundaire gebruiksdoel. Datasets die beschikbaar zijn in de EU zijn te vinden in een catalogus van gezondheidsgevens. Zodra de data zijn gevonden, kan de datagebruiker beginnen met het aanvragen van de gegevens.
...
In TEHDAS2 is een eerste aanzet gemaakt om het proces van secundair gebruik naar requirements.[^inleiding-2] Voor PLUGIN zijn de functionele vereisten voor BVOs en gefedereerde gegevensverwerking de meest essentiele omdat die expliciet aangeven wat er nodig is om datahouders en datagebruikers te ondersteunen. Het is goed om te benadrukken dat TEHDAS2 hierin ook expliciet ingaat op verschillende vormen van _federated computing_. 
...
## Vereisten voor Beveiligde Verwerkingsomgeving (BVO)
...
::: {.callout-caution collapse="true"}
## Vereisten voor gefedereerde gegevensverwerking (FC)
| ID | Vereisten |
|----|-----------|
...
::: {.callout-caution collapse="true"}
## Federatieve BVO-vereisten (FSPE)
| ID | Vereisten |
|----|-----------|
...
::: {.callout-caution collapse="true"}
## Vereisten voor technische interoperabiliteit (TIR)
...
Naast de functionele eisen, streeft PLUGIN ernaar om de kwaliteitseisen zoals in TEHDAS2 zijn geformuleerd te realiseren. De eisen zijn in onderstaande tabellen weergegeven. **TO DO:** prioritering toevoegen aan tabellen(laag-middel-hoog).

::: {.callout-caution collapse="true"}
## Vereisten voor gevoelige data (SD)
| ID | Vereisten |
|----|-----------|
...
::: {.callout-caution collapse="true"}
## European Health Data Space (EHDS) BVO-vereisten
...
::: {.callout-caution collapse="true"}
## Operationele (OP) EHDS BVO-vereisten
...
|-------------|-----------------|---------------------|
| *Datahouders* | *\<Contact-1\>* | *\<Verwachting-1\>* |
| *Datagebruikers* | *\<Contact-2\>* | *\<Verwachting-2\>* |

[^inleiding-1]: TEHDAS staat voor Towards European Health Data Space. Het is een samenwerking van 29 Europese landen om gezondheidsgegevens op een verantwoord manier herbruikbaar te maken, bijvoorbeeld voor onderzoek, innovatie of beleid. Binnen deze samenwerking worden richtlijnen en specificaties geschreven, die voor een deel terugkomen in uitvoeringshandelingen. TEHDAS2 refereert naar de tweede consultatie ronde van richtlijnen en ontwerpprincipes.
[^inleiding-2]: TEHDAS2 [7.4 Draft technical, functional and security specifications of Secure Processing Environments](https://tehdas.eu/wp-content/uploads/2025/09/draft-technical-functional-and-security-specifications-of-secure-processing-environments.pdf)